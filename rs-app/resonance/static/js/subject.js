...
function editDivision(Attr,name,code,description,ms_id,c_id){
    ...
    $(`select[name="classs_id"] option[value="${c_id}"]`).attr('selected', 'selected');
    $('select[name="classs_id"]').selectpicker('refresh');
...
jQuery('.add-division-link').click(function(){
    ...
    $('select[name="classs_id"]').selectpicker('val','');
    $('#edit_value_id').val();
    $('#label').val("");
    $('#code').val("");
    $('#description').val("");
